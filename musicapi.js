var musicapi={
  get:function(details,callback){
    ...
    }else if(details.kugou&&details.kugou.hash){
    ...
    }else if(details.netease&&details.netease.id){
  ...
  _qq:function(mid,cb){
    var c=0,d={};
    var a=musicapi._request('https://api.vkeys.cn/API/QQ_Music?q=8&mid='+mid,function(r){
      if(r==false||r.code!=200){
        b.abort();
        a=musicapi._request('https://api.gumengya.com/Api/Tencent?format=json&id='+mid,function(res){
    ...
    var b=musicapi._request('https://api.vkeys.cn/API/QQ_Music/Lyric?mid='+mid,function(r){
      if(r==false||r.code!=200){
        d.lrc={0:"歌词获取失败"}
  ...
  _netease:function(id,cb){
    var c=0,d={};
    var a=musicapi._request('https://api.vkeys.cn/API/Netease_Cloud?q=4&id='+id,function(r){
      if(r==false||r.code!=200){
        b.abort();
        a=musicapi._request('https://api.gumengya.com/Api/Netease?format=json&id='+id,function(res){
          if(res==false||!res.data){
            cb({
              error:'获取歌曲失败',
              code:10000
    ...
    var b=musicapi._request('https://api.vkeys.cn/API/Netease_Cloud/Lyric?id='+id,function(r){
      if(r==false||r.code!=200){
        d.lrc={0:"歌词获取失败"}
        d.lrcstr='[00:00.00] 歌词获取失败'
      }else{
